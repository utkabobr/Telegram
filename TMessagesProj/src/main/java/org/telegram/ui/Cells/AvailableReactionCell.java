...
public class AvailableReactionCell extends FrameLayout {
    ...
    public AvailableReactionCell(@NonNull Context context) {
        super(context);
    ...
    public void bind(TLRPC.TL_availableReaction react, boolean checked) {
        ...
        SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(react.static_icon.thumbs, Theme.key_windowBackgroundGray, 1.0f);
